...
function App() {
    ...
    const handleDownload = async () => {
        ...
        try {
            const response = await axios.get('http://localhost:3000/viaticos/reporte-excel', {
                params: {
            ...
            const nombreArchivo = `reporte_viaticos_${fechaInicioStr}_a_${fechaFinStr}${folio ? `_folio_${folio}` : ''}.xlsx`;
            link.href = url;
    ...
    return (
        <div className="p-5 flex justify-content-center">
            ...
            <Card title="Reporte Excel" className="w-full md:w-4">
